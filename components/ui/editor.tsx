...
function CodeEditor({
  ...
  return (
    <div className="border rounded-lg px-2 mt-4">
      <CodeEditorPrimitive
        data-slot="textarea"
        className={cn(
          // Self
          ...
          // Inner div
          "[&>.w-tc-editor-preview]:px-2! [&>.w-tc-editor-preview]:py-0! [&>.w-tc-editor-preview]:m-0! [&>.w-tc-editor-preview]:min-h-16!",
          ...
          // Inner textarea
          "[&>.w-tc-editor-text]:px-3! [&>.w-tc-editor-text]:py-0! [&>.w-tc-editor-text]:m-0!",
